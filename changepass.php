    ...
    <div class="d-flex">
        ...
        <div class="sidebar p-3" style="width: 400px;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-1"><a href="#" class="nav-link text-light fw-bold"><i class='bx bxl-blogger'></i> Change Password </a></li>
        ...
        <div class="w-100">
            ...
            <div class="container" style="height: 550px; background-color: #bdc3c7;">
                <div class="row p-5">
                    <div class="col-md-6 mt-3 mx-auto p-5 bg-light" style="border-radius: 15px;">
                       <form action="changepasscode.php" method="post">
                        <label>Old Password</label>
                        <input type="password" class="form-control mb-3" name="Opass">
                        <label>New Password</label>
                        <input type="password" class="form-control mb-3" name="npass">
                        <label>Confirm Password</label>
                        <input type="password" class="form-control mb-3" name="cpass">
                        <button type="submit" class="btn btn-danger w-100">Forgot Password</button>
                       </form>
                    </div>
                </div>
            </div>
